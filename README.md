...
1. Expand the Outputs Section and look for ```IngestionBucket```
1. Copy this value into a text editor, you will need it later.

**Anywhere you see *ingestionbucket* in the lab, you will need to replace it with this value!**

The workshop is now ready to begin!
...
5. On **Data Store** step, choose S3 from **Choose a data store** drop down. Choose `s3://ingestionbucket/raw` S3 bucket location from **Include path**. ***Remember to replace ingestionbucket with your bucket name from the cloudformation script***.
...
1. Remember to replace *ingestionbucket* with the name of the ingestion bucket.
